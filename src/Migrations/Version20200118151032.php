 ...
 */
final class Version20200118151032 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE course_cv DROP date_start, DROP date_end');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE course_cv ADD date_start DATETIME NOT NULL, ADD date_end DATETIME NOT NULL');
