 ...
 */
final class Version20200113062141 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE course_cv CHANGE dateend date_end DATETIME NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE course_cv CHANGE date_end dateend DATETIME NOT NULL');
